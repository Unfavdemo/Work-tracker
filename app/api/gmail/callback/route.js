...
export async function GET(request) {
  try {
    ...
    const html = `
      ...
      <html>
        <head>
          <title>Authenticating Gmail...</title>
        </head>
        <body>
          <div style="display: flex; align-items: center; justify-content: center; height: 100vh; font-family: system-ui;">
            <div style="text-align: center;">
              ...
              <p style="color: #6b7280; font-size: 14px;">Completing Gmail authentication...</p>
            </div>
          </div>
          <script>
            (function() {
    ...
    const errorHtml = `
      ...
      <html>
        ...
        <body>
          <div style="display: flex; align-items: center; justify-content: center; height: 100vh; font-family: system-ui;">
            <div style="text-align: center;">
              <p style="color: #ef4444; font-size: 14px;">Gmail authentication failed. Please try again.</p>
            </div>
          </div>
          <script>
            if (window.opener) {
